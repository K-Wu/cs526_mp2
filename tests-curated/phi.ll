...
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -basicaa -slpvect-kdw -slp-threshold=-100 -dce -S -mtriple=i386-apple-macosx10.8.0 -mcpu=corei7-avx | FileCheck %s
