...
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -mtriple=x86_64-unknown -basicaa -slpvect-kdw -S | FileCheck %s --check-prefix=CHECK --check-prefix=SSE
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -mtriple=x86_64-unknown -mcpu=slm -basicaa -slpvect-kdw -S | FileCheck %s --check-prefix=CHECK --check-prefix=SLM
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -mtriple=x86_64-unknown -mcpu=corei7-avx -mattr=-prefer-128-bit -basicaa -slpvect-kdw -S | FileCheck %s --check-prefix=CHECK --check-prefix=AVX --check-prefix=AVX1
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -mtriple=x86_64-unknown -mcpu=corei7-avx -mattr=+prefer-128-bit -basicaa -slpvect-kdw -S | FileCheck %s --check-prefix=CHECK --check-prefix=SSE
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -mtriple=x86_64-unknown -mcpu=core-avx2 -mattr=-prefer-128-bit -basicaa -slpvect-kdw -S | FileCheck %s --check-prefix=CHECK --check-prefix=AVX --check-prefix=AVX2
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -mtriple=x86_64-unknown -mcpu=core-avx2 -mattr=+prefer-128-bit -basicaa -slpvect-kdw -S | FileCheck %s --check-prefix=CHECK --check-prefix=SSE
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -mtriple=x86_64-unknown -mcpu=knl -basicaa -slpvect-kdw -S | FileCheck %s --check-prefix=CHECK --check-prefix=AVX512 --check-prefix=AVX512F
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -mtriple=x86_64-unknown -mcpu=skx -mattr=-prefer-256-bit -basicaa -slpvect-kdw -S | FileCheck %s --check-prefix=CHECK --check-prefix=AVX512 --check-prefix=AVX512BW
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -mtriple=x86_64-unknown -mcpu=skx -mattr=+prefer-256-bit -basicaa -slpvect-kdw -S | FileCheck %s --check-prefix=CHECK --check-prefix=AVX --check-prefix=AVX2
