...
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -slpvect-kdw -S -mtriple=x86_64-- -mattr=+avx  | FileCheck %s --check-prefixes=CHECK,AVX1
; RUN: opt < %s -load %S/../build/pass/libSLPVectorizer-kdw.so -slpvect-kdw -S -mtriple=x86_64-- -mattr=+avx2 | FileCheck %s --check-prefixes=CHECK,AVX2
