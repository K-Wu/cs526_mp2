...
; RUN: opt -load %S/../build/pass/libSLPVectorizer-kdw.so -slpvect-kdw -slp-vectorize-hor -slp-vectorize-hor-store -S < %s -mtriple=x86_64-apple-macosx -mcpu=haswell | FileCheck %s
