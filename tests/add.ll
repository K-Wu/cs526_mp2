...
; CHECK-NEXT:    [[TMP4:%.*]] = fadd <4 x float> [[TMP1]], [[TMP2]]
...
; CHECK-NEXT:    [[TMP4:%.*]] = fadd <4 x float> [[TMP3]], [[TMP2]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = fadd <4 x float> [[TMP1]], [[TMP6]]
...
; CHECK-NEXT:    [[TMP11:%.*]] = fadd <2 x double> [[TMP10]], [[TMP3]]
...
;  but not 2nd or 4th as fadd is not commutative.
